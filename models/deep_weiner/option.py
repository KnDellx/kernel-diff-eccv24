import argparse
from models.deep_weiner.template import set_template
...
parser.add_argument("--kernel",type=int,default=0,help="Give index of kernel")
parser.add_argument('--filenumber', type=int, default=100, help='Input File Format')
parser.add_argument("--M",type=float,default=10,help="Photon Level")
